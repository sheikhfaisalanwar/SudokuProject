export const possibleSudokuValues = ['1', '2', '3', '4', '5', '6', '7', '8', '9'];
export const defaultPuzzle = '856014730090000000240000160062059300031802450005340920024000073000000010018630294';
